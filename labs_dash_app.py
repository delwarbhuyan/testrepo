...
max_payload_mass = spacex_df['Payload Mass (kg)'].max()

min_payload_mass = spacex_df['Payload Mass (kg)'].min()
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard', style={'textAlign': 'center', 'color': '#503D36','font-size': 40}),
                                ...
                                dcc.RangeSlider(id='payload-slider', min = 0, max = 10000, step = 1000, value = [min_payload_mass, max_payload_mass], marks={ 2500: {'label': '2500 (Kg)'}, 5000: {'label': '5000 (Kg)'}, 7500: {'label': '7500 (Kg)'}}),
